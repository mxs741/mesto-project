export class FormValidator {
  constructor(settings, formElement ) { // settings: см. index enableValidation...
    {
      this._form = formElement;
      this._inputElement = settings.inputSelector;
      this._btmSubmitElement = setting.btnSelector;
      this._btmSubmitDisabledClass = Inactive;
      this._formInputErrorClass = formInputError;
      this._formErrorMessageClass = formErrorMessage;
    }
  }
}
